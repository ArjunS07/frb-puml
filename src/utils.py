...
def get_subburst_preserved_train_test(
    ...
    sub-bursts for aech burst back to the training and test sets.
    """
    ...
    if (
        stratify
    ):  # Stratifications is done to preserve the ratio of repeaters to non-repeaters in the training and test sets. We allow the user of the function to specify whether they want to implement it
...
REFERENCE_PAPER_REPEATERS = list(
    set(SUPERVISED_PAPER_REPEATERS + UNSUPERVISED_PAPER_REPEATERS)
)
